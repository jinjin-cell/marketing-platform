...
-- ----------------------------
INSERT INTO `xxl_job_group` VALUES (1, 'big-market-job', '大营销调度任务', 0, NULL, '2024-08-10 09:18:32');
...
-- ----------------------------
INSERT INTO `xxl_job_info` VALUES (1, 1, '更新奖品库存任务', '2018-11-03 22:21:31', '2024-08-10 09:17:47', 'XXL', '', 'CRON', '0/5 * * * * ?', 'DO_NOTHING', 'FIRST', 'updateAwardStockJob', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2018-11-03 22:21:31', '', 0, 0, 0);
INSERT INTO `xxl_job_info` VALUES (2, 1, '发送MQ消息任务队列(DB1)', '2024-08-10 09:09:27', '2024-08-10 09:15:44', 'XXL', '', 'CRON', '0/5 * * * * ?', 'DO_NOTHING', 'FIRST', 'SendMessageTaskJob_DB1', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2024-08-10 09:09:27', '', 1, 1723252715000, 1723252720000);
INSERT INTO `xxl_job_info` VALUES (3, 1, '发送MQ消息任务队列(DB2)', '2024-08-10 09:09:38', '2024-08-10 09:15:40', 'XXL', '', 'CRON', '0/5 * * * * ?', 'DO_NOTHING', 'FIRST', 'SendMessageTaskJob_DB2', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2024-08-10 09:09:38', '', 1, 1723252715000, 1723252720000);
INSERT INTO `xxl_job_info` VALUES (4, 1, '更新活动sku库存任务', '2024-08-10 09:10:09', '2024-08-10 09:15:00', 'XXL', '', 'CRON', '0/5 * * * * ?', 'DO_NOTHING', 'FIRST', 'UpdateActivitySkuStockJob', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2024-08-10 09:10:09', '', 1, 1723252715000, 1723252720000);
...
-- ----------------------------
INSERT INTO `xxl_job_log` VALUES (111, 1, 4, NULL, 'UpdateActivitySkuStockJob', '', NULL, 0, '2024-08-10 09:18:30', 500, '任务触发类型：Cron触发<br>调度机器：172.19.0.12<br>执行器-注册方式：自动注册<br>执行器-地址列表：null<br>路由策略：第一个<br>阻塞处理策略：单机串行<br>任务超时时间：0<br>失败重试次数：0<br><br><span style=\"color:#00c0ef;\" > >>>>>>>>>>>触发调度<<<<<<<<<<< </span><br>调度失败：执行器地址为空<br><br>', NULL, 0, NULL, 0);
INSERT INTO `xxl_job_log` VALUES (112, 1, 2, NULL, 'SendMessageTaskJob_DB1', '', NULL, 0, '2024-08-10 09:18:35', 500, '任务触发类型：Cron触发<br>调度机器：172.19.0.12<br>执行器-注册方式：自动注册<br>执行器-地址列表：null<br>路由策略：第一个<br>阻塞处理策略：单机串行<br>任务超时时间：0<br>失败重试次数：0<br><br><span style=\"color:#00c0ef;\" > >>>>>>>>>>>触发调度<<<<<<<<<<< </span><br>调度失败：执行器地址为空<br><br>', NULL, 0, NULL, 0);
INSERT INTO `xxl_job_log` VALUES (113, 1, 4, NULL, 'UpdateActivitySkuStockJob', '', NULL, 0, '2024-08-10 09:18:35', 500, '任务触发类型：Cron触发<br>调度机器：172.19.0.12<br>执行器-注册方式：自动注册<br>执行器-地址列表：null<br>路由策略：第一个<br>阻塞处理策略：单机串行<br>任务超时时间：0<br>失败重试次数：0<br><br><span style=\"color:#00c0ef;\" > >>>>>>>>>>>触发调度<<<<<<<<<<< </span><br>调度失败：执行器地址为空<br><br>', NULL, 0, NULL, 0);
INSERT INTO `xxl_job_log` VALUES (114, 1, 3, NULL, 'SendMessageTaskJob_DB2', '', NULL, 0, '2024-08-10 09:18:35', 500, '任务触发类型：Cron触发<br>调度机器：172.19.0.12<br>执行器-注册方式：自动注册<br>执行器-地址列表：null<br>路由策略：第一个<br>阻塞处理策略：单机串行<br>任务超时时间：0<br>失败重试次数：0<br><br><span style=\"color:#00c0ef;\" > >>>>>>>>>>>触发调度<<<<<<<<<<< </span><br>调度失败：执行器地址为空<br><br>', NULL, 0, NULL, 0);
...
-- ----------------------------
INSERT INTO `xxl_job_log_report` VALUES (1, '2024-08-10 00:00:00', 0, 45, 39, NULL);
INSERT INTO `xxl_job_log_report` VALUES (2, '2024-08-09 00:00:00', 0, 0, 0, NULL);
INSERT INTO `xxl_job_log_report` VALUES (3, '2024-08-08 00:00:00', 0, 0, 0, NULL);
