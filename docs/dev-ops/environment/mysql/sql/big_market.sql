/*
 * Marketing platform database initialization script.
 *
 * This script recreates the tables used by the MyBatis mappers and seeds the
 * same data currently in the big_market development database (111.228.17.153).
 */
...
INSERT INTO `strategy_rule`
  (`id`, `strategy_id`, `award_id`, `rule_type`, `rule_model`, `rule_value`, `rule_desc`, `create_time`, `update_time`)
VALUES
...
VALUES
  (1, 'tree_lock_1', 'rule_lock', 'rule_stock', 'EQUAL', 'ALLOW', '2024-01-27 10:03:09', '2024-02-15 07:55:08'),
  (2, 'tree_lock_1', 'rule_lock', 'rule_luck_award', 'EQUAL', 'TAKE_OVER', '2024-01-27 10:03:09', '2024-02-15 07:55:11'),
  (3, 'tree_lock_1', 'rule_stock', 'rule_luck_award', 'EQUAL', 'ALLOW', '2024-01-27 10:04:43', '2024-02-15 07:55:13'),
  (4, 'tree_luck_award', 'rule_stock', 'rule_luck_award', 'EQUAL', 'ALLOW', '2024-02-15 07:37:31', '2024-02-15 07:39:28'),
  (5, 'tree_lock_2', 'rule_lock', 'rule_stock', 'EQUAL', 'ALLOW', '2024-01-27 10:03:09', '2024-02-15 07:55:08'),
  (6, 'tree_lock_2', 'rule_lock', 'rule_luck_award', 'EQUAL', 'TAKE_OVER', '2024-01-27 10:03:09', '2024-02-15 07:55:11'),
  (7, 'tree_lock_2', 'rule_stock', 'rule_luck_award', 'EQUAL', 'ALLOW', '2024-01-27 10:04:43', '2024-02-15 07:55:13');
